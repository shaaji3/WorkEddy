...
<div x-data="videoScanPage">
  ...
  <div>
    ...
    <div class="alert alert-danger align-items-center gap-2" x-show="error" x-text="error" x-cloak></div>
      ...
      <form @submit.prevent="submit">
                ...
                <div class="d-flex gap-2 flex-wrap mt-1">
                  <template x-for="m in models" :key="m.value">
                    <button type="button" class="btn btn-sm"
                      ...
                      @click="if (!parentScanId) model = m.value" :disabled="parentScanId != null"
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <input class="form-control" id="videoFile" type="file" x-ref="videoFile" @change="onFileChange()"
            ...
            <div class="mt-3" x-show="videoPreviewUrl" x-cloak>
              ...
              <video class="w-100 rounded border" style="max-height:320px;background:#000" controls preload="metadata"
                :src="videoPreviewUrl">
              </video>
            </div>
    ...
    <div x-show="scanId" x-cloak>
      ...
      <!-- Processing banner -->
      <div class="alert alert-info align-items-center gap-2" x-show="resultPending" x-cloak style="display:none"
        :style="resultPending ? 'display:flex' : 'display:none'">
      ...
      <div class="alert alert-danger align-items-start gap-2" x-show="scanInvalid" x-cloak style="display:none"
        :style="scanInvalid ? 'display:flex' : 'display:none'">
      ...
      <div x-show="scan && scan.status === 'completed' && !scanInvalid" x-cloak>
        <div class="row g-4 mb-4">
          <div class="col-lg-4">
            <div class="card h-100">
              <div class="card-body text-center py-4">
                ...
                <span class="badge px-3 py-2 text-wrap fs-10" :class="riskLevelCategory === 'high' ? 'badge-soft-danger'
                            : riskLevelCategory === 'moderate' ? 'badge-soft-warning'
                            : 'badge-soft-success'" x-text="riskLevel"></span>
          ...
          <div class="col-lg-8">
            <div class="card h-100">
              <div class="card-header">
                <h6 class="mb-0 fw-semibold">Scan Details</h6>
              </div>
              <div class="card-body">
                <dl class="row mb-0">
                  <dt class="col-sm-4 text-muted text-sm">Model</dt>
                  <dd class="col-sm-8"><span class="badge badge-soft-primary text-uppercase"
                      x-text="scan?.model ?? '—'"></span></dd>
