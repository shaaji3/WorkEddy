...
<!-- Page Header -->
  <header class="page-header text-center position-relative">
    <div class="container relative z-1">
      ...
      <h1 class="fw-bold mb-4 text-white" style="font-size:3.5rem; letter-spacing: -1px;">Why we built WorkEddy</h1>
    </div>
  </header>
  ...
  <main class="pb-5">
    <div class="container">
            ...
            <div>
              ...
              <div class="d-inline-flex bg-success bg-opacity-10 text-emerald border border-success border-opacity-25 rounded-3 px-3 py-2">
                <div class="d-flex align-items-center gap-2">
                  ...
                  <span class="fw-bold lh-sm text-uppercase font-mono" style="font-size: 0.70rem; letter-spacing: 0.5px;">IRCA Certified ISO 45001<br>Lead Auditor</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 col-xl-7">
          <div class="story-content tech-panel p-4 p-md-5">
